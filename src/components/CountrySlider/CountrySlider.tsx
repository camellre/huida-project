...
export const CountrySlider = () => {
  return (
    <article className={style.countrySliderWrapper}>
      ...
      <div
        className={[style.contentBackground, style.content_2_Background].join(
          " "
        )}
      >
        <div className={style.content_1_Shadow}></div>
      ...
      <div
        className={[style.contentBackground, style.content_3_Background].join(
          " "
        )}
      >
        <div className={style.content_1_Shadow}></div>
      ...
      <div
        className={[style.contentBackground, style.content_4_Background].join(
          " "
        )}
      >
        <div className={style.content_1_Shadow}></div>
      ...
      <div
        className={[style.contentBackground, style.content_5_Background].join(
          " "
        )}
      >
        <div className={style.content_1_Shadow}></div>
      ...
      <div
        className={[style.contentBackground, style.content_6_Background].join(
          " "
        )}
      >
        <div className={style.content_1_Shadow}></div>
      ...
      <div
        className={[style.contentBackground, style.content_7_Background].join(
          " "
        )}
      >
        <div className={style.content_1_Shadow}></div>
      ...
      <div
        className={[style.contentBackground, style.content_8_Background].join(
          " "
        )}
      >
        <div className={style.content_1_Shadow}></div>
      </div>
      <div className={style.contentSliderWrapper}>
        ...
        <div>
          <div
            className={[style.contentWrapper, style.content_1_Wrapper].join(
              " "
            )}
          >
            <p>Antigua & Barbuda</p>
          ...
          <div
            className={[style.contentWrapper, style.content_2_Wrapper].join(
              " "
            )}
          >
            <p>St. Kitts & Nevis</p>
          ...
          <div
            className={[style.contentWrapper, style.content_3_Wrapper].join(
              " "
            )}
          >
            <p>Dominica</p>
          ...
          <div
            className={[style.contentWrapper, style.content_4_Wrapper].join(
              " "
            )}
          >
            <p>Grenada</p>
          ...
          <div
            className={[style.contentWrapper, style.content_5_Wrapper].join(
              " "
            )}
          >
            <p>Portugal</p>
          ...
          <div
            className={[style.contentWrapper, style.content_6_Wrapper].join(
              " "
            )}
          >
            <p>Malta</p>
          ...
          <div
            className={[style.contentWrapper, style.content_7_Wrapper].join(
              " "
            )}
          >
            <p>Türkiye</p>
          ...
          <div
            className={[style.contentWrapper, style.content_8_Wrapper].join(
              " "
            )}
          >
