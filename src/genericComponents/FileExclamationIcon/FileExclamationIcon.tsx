interface FileExclamationIconProps {
  fileExclamationIconStyle?: string;
}

export const FileExclamationIcon = ({
  fileExclamationIconStyle,
}: FileExclamationIconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={fileExclamationIconStyle}
      viewBox="0 0 576 512"
    >
